...
def test_read_note(test_app, monkeypatch):
    test_data = {"id": 1, "title": "something", "description": "sample"}
...
def test_update_note(test_app, monkeypatch):
    test_update_data = {"title": "testing", "description": "update", "id": 1}
...
def test_update_note_valid(test_app, monkeypatch, id, payload, status_code):
    async def mock_get(id):
        return None
...
def test_remove_note(test_app, monkeypatch):
    test_data = {"title": "something", "description": "blah blah", "id": 1}
